    ...
    <div id="title">
       ...
       <h1 id="greeting" >Hello, <span id="username">{{$username}}</span></h1> 
        ...
        <div id="chat-bottom"  class="col-lg-12">
            ...
            <input type="button" value="Send Message" onclick="sendMessage()" style ="background-color: #FF8C00 ; border-radius: 10px; width: 100px; color: #F8F8FF; font-family: Charcoal;">
        </div>
    </div>
...
function retrieveChatMessages()
{
    ...
    $.ajax({
        ...
        type: 'POST',
        data: {_token: CSRF_TOKEN, username: user_name,roomname: room_name},
        dataType: 'JSON',
...
function sendMessage()
{
    ...
    if (text.length > 0)
    {
        ...
        $.ajax({
            url: 'sendMessage',
            type: 'POST',
            data: {_token: CSRF_TOKEN, text: text, username: user_name,roomname: room_name},
            dataType: 'JSON',
            success: function (data) {
                console.log(data);
